...
use crate::{
    require, wasm_input, wasm_trace_size,wasm_read_context, wasm_write_context
};
...
pub const DATA: [u64; 4] = [1, 2, 3, 4];
pub fn set_merkle_leaf(index: u32) {
   
    let mut merkle = Merkle::new();
    
    merkle.set(index, &DATA, false, None);
...
pub fn read_merkle_leaf(index: u32) {
    let merkle = Merkle::load([
        682346781077866974,
        2352964591531621882,
        14381146627477592611,
        3184921250897295165,
    ]);
    let (hash, data) = merkle.get(index, false);
    dbg!("leaf is {:?}...\n", hash);
    dbg!("data is {:?}...\n", data);
    unsafe {require(data == DATA)};
    let root = merkle.root;
    dbg!("root is {:?}...\n", root);
}
...
//     let sum = input_pub_1 + input_pub_2;
...
// Test massive dbg logs
// #[wasm_bindgen]
// pub fn zkmain() -> i64 {
//     for i in 0..1000 {
//         crate::dbg!("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec varius dictum dolor, ac porttitor urna tristique ac. Phasellus faucibus ultrices nulla in scelerisque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla facilisi. Proin non metus est. Integer quis dolor eu nunc lacinia iaculis sed sed felis. Vestibulum convallis commodo aliquam. Morbi aliquet ut ante quis posuere. Maecenas sed enim odio.\n");
//         crate::dbg!("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec varius dictum dolor, ac porttitor urna tristique ac. Phasellus faucibus ultrices nulla in scelerisque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla facilisi. Proin non metus est. Integer quis dolor eu nunc lacinia iaculis sed sed felis. Vestibulum convallis commodo aliquam. Morbi aliquet ut ante quis posuere. Maecenas sed enim odio.\n");
//         crate::dbg!("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec varius dictum dolor, ac porttitor urna tristique ac. Phasellus faucibus ultrices nulla in scelerisque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla facilisi. Proin non metus est. Integer quis dolor eu nunc lacinia iaculis sed sed felis. Vestibulum convallis commodo aliquam. Morbi aliquet ut ante quis posuere. Maecenas sed enim odio.\n");
//         crate::dbg!("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec varius dictum dolor, ac porttitor urna tristique ac. Phasellus faucibus ultrices nulla in scelerisque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla facilisi. Proin non metus est. Integer quis dolor eu nunc lacinia iaculis sed sed felis. Vestibulum convallis commodo aliquam. Morbi aliquet ut ante quis posuere. Maecenas sed enim odio.\n");
//         crate::dbg!("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec varius dictum dolor, ac porttitor urna tristique ac. Phasellus faucibus ultrices nulla in scelerisque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla facilisi. Proin non metus est. Integer quis dolor eu nunc lacinia iaculis sed sed felis. Vestibulum convallis commodo aliquam. Morbi aliquet ut ante quis posuere. Maecenas sed enim odio.\n");
